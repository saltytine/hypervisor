...
fn handle_psci_smc(_frame: &mut TrapFrame, code: u64, _arg0: u64, _arg1: u64, _arg2: u64) -> u64 {
    match code {
        ...
        PsciFnId::PSCI_CPU_ON_64 | PsciFnId::PSCI_CPU_ON_64 => psci_emulate_cpu_on(frame),
