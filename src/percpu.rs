...
use crate::memory::{
    MemFlags, MemoryRegion, MemorySet, PARKING_INST_PAGE, PARKING_MEMORY_SET, VIRT_PHYS_OFFSET,
};
...
pub fn park_current_cpu() {
    ...
    PARKING_MEMORY_SET.call_once(|| {
        ...
        gpm.insert(MemoryRegion::new_with_offset_mapper(
            0 as GuestPhysAddr,
            unsafe { &PARKING_INST_PAGE as *const _ as HostPhysAddr - VIRT_PHYS_OFFSET },
            PAGE_SIZE,
            MemFlags::READ | MemFlags::WRITE | MemFlags::IO,
        ))
        .unwrap();
